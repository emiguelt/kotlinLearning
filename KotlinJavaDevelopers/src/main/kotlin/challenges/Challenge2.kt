...
fun main(args: Array<String>) {
    ...
    val array1 = arrayOf<Short>(1,2,3,4,5)
    ...
    val array2 = Array<Int?>(40){i -> (i+1)*5}
    ...
    val myNonNull: Int? = null
    println(myNonNull!!.toString())
